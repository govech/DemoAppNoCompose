...
class PerformanceMonitor
    ...
    constructor(
        ...
        private fun initStartupTimeTracker(application: Application) {
            ...
            // 添加启动监听器
            startupTimeTracker.addStartupListener(
                object : StartupTimeTracker.StartupListener {
                    override fun onStartupPhaseCompleted(
                        phase: StartupTimeTracker.StartupPhase,
                        duration: Long,
                    ) {
        ...
        private fun initMemoryMonitor() {
            ...
            // 添加内存监听器
            memoryMonitor.addMemoryListener(
                object : MemoryMonitor.MemoryListener {
                    ...
                    override fun onMemoryPressure(
                        ...
                        level: MemoryMonitor.MemoryPressureLevel,
                    ) {
        ...
        private fun initNetworkPerformanceMonitor() {
            ...
            // 添加网络性能监听器
            networkPerformanceInterceptor.addPerformanceListener(
                object : NetworkPerformanceInterceptor.NetworkPerformanceListener {
                    ...
                    override fun onRequestFailed(
                        performanceInfo: NetworkPerformanceInterceptor.NetworkPerformanceInfo,
                        error: Throwable,
                    ) {
