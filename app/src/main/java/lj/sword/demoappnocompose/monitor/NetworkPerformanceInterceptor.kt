 ...
 */
@Singleton
class NetworkPerformanceInterceptor @Inject constructor(
    ...
    interface NetworkPerformanceListener {
        ...
        fun onRequestFailed(performanceInfo: NetworkPerformanceInfo, error: Throwable)
    }
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        try {
            ...
            // 创建性能信息
            val performanceInfo = createPerformanceInfo(
     ...
     * 通知监听器
     */
    private fun notifyListeners(info: NetworkPerformanceInfo, error: Throwable?) {
